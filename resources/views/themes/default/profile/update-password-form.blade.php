<x-form-section submit="updatePassword">
    ...
    <x-slot name="description">
        {{ __('common.update_password_text') }}
    </x-slot>

    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <x-label for="current_password" value="{{ __('common.password_current') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password" value="{{ __('common.password_new') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password_confirmation" value="{{ __('common.password_new_confirm') }}" />
