@props(['title' => __('common.password_confirm'), 'content' => __('common.require_confirm_password_text'), 'button' => __('common.confirm')])
    ...
    <x-dialog-modal wire:model="confirmingPassword">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
                <x-input type="password" class="mt-1 block w-3/4" placeholder="{{ __('common.password') }}"
