    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="<?php echo action('\Barryvdh\TranslationManager\Controller@getIndex') ?>">Home <span class="sr-only">(current)</span></a></li>
                <li><a href="<?php echo route('admin.index'); ?>">Back to Admin</a></li>
            </ul>
        </div>
    </div>
</header>
        ...
        <fieldset>
            ...
            <form class="form-add-locale" method="POST" role="form" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postAddLocale') ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <input type="text" id="new-locale" name="new-locale" class="form-control" list="languagesList" />
                            <datalist id="languagesList">
                                ...
                                <option value="uk">
                                <option value="ur">
                                <option value="uz_Cyrl">
                                <option value="uz_Latn">
                                <option value="vi">
                                <option value="zh_CN">
                                <option value="zh_HK">
                                <option value="zh_TW">
                            </datalist>
                            <small class="help-block">See the full list <a href="https://github.com/Laravel-Lang/lang/tree/main/locales" target="_blank">here</a></small>
                        </div>
                        <div class="col-sm-2">
