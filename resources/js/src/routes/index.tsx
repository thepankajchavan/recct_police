...
const VTS = React.lazy(()=>import('./../views/dashboards/VTS'))
const SitewiseVehicles = React.lazy(() => import('./../views/dashboards/SitewiseVehicles'))
...
const NavSettings = React.lazy(()=> import('./../views/uielements/base/NavSettings'))
...
const VehicleTables = React.lazy(() => import('./../views/uielements/tables/VehicleTables'))
const VTSTable = React.lazy(()=> import('./../views/uielements/tables/VTSTable'))
const ReactTable = React.lazy(() => import('./../views/uielements/tables/ReactTable'))
const VendorMaster = React.lazy(() => import('./../views/uielements/tables/VendorMaster'))
const UserTable = React.lazy(()=>import('./../views/uielements/tables/UserTable'))
const AdminTable = React.lazy(()=>import('./../views/uielements/tables/AdminTable'))
const RolesTable = React.lazy(()=>import('./../views/uielements/tables/RolesTable'))
...
const AddVehicleForm = React.lazy(() => import('./../views/uielements/forms/AddVehicleForm'))
...
const AddVendorForm = React.lazy(() => import('./../views/uielements/forms/AddVendorForm'))
const AddUsersForm = React.lazy(()=>import('./../views/uielements/forms/AddUsersForm'))
const AddAdminForm = React.lazy(()=>import('./../views/uielements/forms/AddAdminForm'))
const AddRoleForm = React.lazy(()=>import('./../views/uielements/forms/AddRoleForm'))
const AddPermissionForm = React.lazy(()=>import('./../views/uielements/forms/AddPermissionForm'))
...
const dashboardRoutes: RoutesProps = {
  ...
  children: [
    ...
    {
      path: '/vehicle/:vehicle_number',
      name: 'VTS',
      element: <VTS />,
      route: PrivateRoute,
    },
    {
      path: '/dashboards/site-wise',
      name: 'Sitewise',
      element: <SitewiseVehicles />,
      route: PrivateRoute,
    },
  ],
}
...
const componentsRoutes: RoutesProps = {
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        {
          path: '/components/tables/vehicle-master',
          name: 'VehicleMaster',
          element: <VehicleTables />,
          route: PrivateRoute,
        },
        {
          path: '/admin/users',
        ...
        },
        {
          ...
          name: 'AdminMenus',
          element: <AdminMenusTable />,
          route: PrivateRoute,
        },
        {
          path: '/admin/news-and-events',
          name: 'NewsAndEvents',
          element: <NewsEventsTable />,
          route: PrivateRoute,
        },
        {
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/components/forms/add-vehicle',
          name: 'AddVehicle',
          element: <AddVehicleForm />,
          route: PrivateRoute,
        },
        {
          path: '/components/forms/add-vendor',
          name: 'AddVendor',
        ...
        {
          path: '/admin/admin-menus/create',
          name: 'AddAdminMenu',
          element: <AddAdminMenuForm />,
          route: PrivateRoute,
        },
        {
          path: '/admin/news-and-events/create',
          name: 'AddNewsEvent',
          element: <AddNewsEvent />,
          route: PrivateRoute,
        },
        {
          path: '/admin/police-station/create',
        ...
        {
          path: '/admin/news-and-events/:id/edit',
          name: 'EditNewsEvents',
