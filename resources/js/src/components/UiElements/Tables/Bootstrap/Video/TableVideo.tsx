                ...
                {users.map((data, idx) => {
                    return (
                        <tr key={idx}>
                            ...
                            <td>
                                <Link to={""+data.vdo_link} target='_blank' className="d-flex gap-3 align-items-center">
                                    <div className="flex-shrink-0" style={{ flexShrink: 0 }}>
                                    <div>{data.vdo_link}</div>

                                    </div>
                                </Link>
                            </td>
                            <td>
                                <form method='post' action={'/admin/video-gallery/' + data.id}>
