                ...
                {(roles || []).map((data, idx) => {
                    return (
                        <tr key={idx}>
                            ...
                            <td>
                                <form method='post' action={'/admin/permissions/' + data.id}>
                                    <input type='hidden' value={token.content} name='_token' />
                                    <input type='hidden' value='DELETE' name='_method' />
                                    <Link to={"/admin/permissions/" + data.id + "/edit"} className='btn px-0 py-0' >
...
export default TablePermissionEle
